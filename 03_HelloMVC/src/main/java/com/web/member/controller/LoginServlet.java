...
import com.web.member.serive.MemberService;
...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//login기능 
		//사용자가 보낸 id, paswword를 가지고 -> request객체에 저장이 되어있음
		//DB의 특정테이블에 있는지 확인하고 있으면 인증처리 없으면 실패처리
		//클라이언트가 보낸 데이터를 가져오려면 request.getParmeter() -> 한개값을 가져올때 
		//|| request.getParterValues() -> 다중값을 가져올때
